...
<div class="banner-bootom-w3-agileits">
	<div class="container">
			...
			<div class="grid images_3_of_2">
				<div class="flexslider">
					<ul class="slides">
							...
							<div class="thumb-image"> <img src="img/upload/product/{{$product->image}}" data-imagezoom="true" class="img-responsive"> </div>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3>{{$product->name}}</h3>
					<p>	@if($product->promotional>0)
                        <span class="item_price">
                            {{number_format($product->promotional)}}
                        </span>
					...
					<div class="occasional">
						<h5>Loại :</h5>
						<div class="colr ert">
							<label class="radio"><input type="radio" name="radio" checked=""><i></i>Đơn Giản</label>
						</div>
						<div class="colr">
					...
					<div class="occasion-cart">
						<div >									
						<button type="submit" class="w3ls-cart" ><a href="{{route('addCart',['id'=>$product->id])}}">Thêm vào giỏ hàng</a></button>
						</div>
					  ...
					  <div class="col-md-3 product-men single">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="men-thumb-item">
										<img src="img/upload/product/{{$product->image}}" alt="" class="pro-image-front">
										<img src="img/upload/product/{{$product->image}}" alt="" class="pro-image-back">
